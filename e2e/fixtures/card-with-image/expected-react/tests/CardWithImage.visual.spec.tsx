...
import { CardWithImage } from "../CardWithImage.view";
...
for (const viewport of viewports) {
	for (const state of states) {
		...
		test("CardWithImage matches source at " + viewportName + " / " + state.name, async ({ mount, page }) => {
			...
			const component = await mount(<CardWithImage />);
			await applyState(page, state);
