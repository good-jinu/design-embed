...
```bash
FIGMA_TOKEN=... FIGMA_URL=... pnpm design-embed plugin --config tests/examples/figma-prestep/design-embed.config.ts --out tests/examples/figma-prestep/raw-design.html
